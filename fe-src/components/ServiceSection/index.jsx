...
const serviceCard = (service, index) => {
    return <div key={index} class="pb-12 relative max-w-l bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
            <img class="rounded-t-lg" src={service.imageSrc} alt={service.imageAlt} />
        </a>
        <div class="p-5">
            <a href="#">
            ...
            <a href="#" class="absolute bottom-5 w-2/8 flex flex-row items-center px-3 py-2 text-sm font-medium text-right text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Learn more
