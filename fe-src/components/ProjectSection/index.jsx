    ...
    {projects && projects.projects.map((project, index) => {
      ...
      <li key={index} className="col-start-2 col-span-10 lg:col-start-4 lg:col-span-6 p-4 border rounded shadow-md hover:shadow-lg transition-shadow duration-300">
        ...
        <div className="flex flex-row py-2 gap-2">
          <a class="text-sm flex items-center gap-1 rounded-lg px-1.5 py-1 bg-gray-800 hover:bg-gray-600" href={project.website_url}>
          ...
          <a class="text-sm flex items-center gap-1 rounded-lg px-1.5 py-1 bg-gray-800 hover:bg-gray-600" href={project.repository_url}>
...
const ProjectSection = () => {
  let titleProps = {
    headerContent:"This is my",
    headerContentUnderline:"projects",
